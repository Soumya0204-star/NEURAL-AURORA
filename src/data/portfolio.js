...
export const services = [
  {
    ...
    delivery: '2-3 weeks',
    pricing: [
      { label: 'Landing Page', price: '1.5k', delivery: '1 week', features: ['Single page', 'Basic SEO', 'Contact form', 'Responsive design'] },
      { label: 'Multi-Page App', price: '2.5k', delivery: '2-3 weeks', features: ['Up to 5 pages', 'API integration', 'Dashboard', 'CMS integration'] },
      { label: 'E-commerce', price: '5k', delivery: '3-5 weeks', features: ['Product catalog', 'Cart & checkout', 'Payment gateway', 'Admin panel'] },
      { label: 'Custom Web App', price: '10k', delivery: '4-8 weeks', features: ['Full custom build', 'Database design', 'Authentication', 'Admin dashboard'] },
    ],
    display_order: 0,
  },
  {
    ...
    delivery: '1-2 weeks',
    pricing: [
      { label: 'UI Audit', price: '0.8k', delivery: '3-5 days', features: ['Heuristic review', 'Accessibility audit', 'Improvement report', 'User flow analysis'] },
      { label: 'Wireframe & Prototype', price: '1.5k', delivery: '1-2 weeks', features: ['Low-fi wireframes', 'High-fi mockups', 'Interactive prototype', 'User testing'] },
      { label: 'Design System', price: '3k', delivery: '2-3 weeks', features: ['Component library', 'Style tokens', 'Documentation', 'Figma source files'] },
      { label: 'Full Product Design', price: '6k', delivery: '3-6 weeks', features: ['Research & strategy', 'UX architecture', 'Visual design', 'Dev handoff'] },
    ],
    display_order: 1,
  },
  {
    ...
    delivery: '2-5 days',
    pricing: [
      { label: 'Code Review', price: '3k', delivery: '2-3 days', features: ['Full code audit', 'Performance analysis', 'Security check', 'Actionable report'] },
      { label: 'Architecture Consult', price: '5k', delivery: '3-5 days', features: ['Stack evaluation', 'System design review', 'Migration strategy', 'Roadmap planning'] },
      { label: 'Team Workshop', price: '8k', delivery: '1 week', features: ['Custom curriculum', 'Live sessions', 'Code exercises', 'Follow-up materials'] },
      { label: 'Fractional CTO', price: '15k', delivery: 'Monthly', features: ['Ongoing guidance', 'Team management', 'Technical decisions', 'Monthly review'] },
    ],
    display_order: 2,
  },
  {
    ...
    delivery: '4-8 weeks',
    pricing: [
      { label: 'MVP Development', price: '5k', delivery: '3-5 weeks', features: ['Core features only', 'Rapid prototyping', 'Iterative builds', 'Market-ready launch'] },
      { label: 'Full Product', price: '10k', delivery: '6-10 weeks', features: ['Complete build', 'Scalable architecture', 'Testing & QA', 'Deployment'] },
      { label: 'Integration', price: '4k', delivery: '1-3 weeks', features: ['Third-party APIs', 'Legacy system bridge', 'Data migration', 'Testing'] },
      { label: 'Maintenance', price: '2k', delivery: 'Monthly', features: ['Bug fixes', 'Updates & patches', 'Monitoring', 'Priority support'] },
    ],
    display_order: 3,
  },
]
